...
-- y las migraciones 0002-0005. Ejecuta esto en el SQL Editor.
--
-- Sube el umbral de envío gratis (Lima Delivery) de S/.200 a S/.250 de
-- subtotal con descuento ya aplicado. Mantener sincronizado con
-- FREE_SHIPPING_THRESHOLD en src/lib/shipping.ts.
--
-- Único cambio respecto a la función de 0005: el umbral usado en el cálculo
-- de v_shipping_cost. La firma no cambia.
